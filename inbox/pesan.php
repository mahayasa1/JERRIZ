...
<div class="container">
  ...
  <br>
  <h3 class="text-center">Selamat datang  <?php echo $_SESSION['nama']; ?> di Halaman Data upload Dokumen</h3>
  <br>
  <a href="tambah_pesan.php" class="btn btn-primary">Tambah</a>
  <br><br>
  <table id="example" class="display nowrap" style="width:100%">
        ...
        <tbody>
            ...
            <tr>
                <td><?= $no++?></td>
                <td><a href="upload/<?=$row['nama_file']?>" target="_blank">
                <?= $row['judul_dokumen']?>
                </a> </td>
                <td><?= $row['keterangan']?></td>
                <td>
                    <a href="pesan_edit.php?id=<?= $row['id_upload']?>" class="btn btn-success btn-sm">Edit</a>
                    <a href="pesan_delete.php?id=<?= $row['id_upload']?>" class="btn btn-danger btn-sm" onclick="return confirm('Anda Yakin Ingin Hapus Data Ini?')">Delete</a>
                </td>
            </tr>
            <?php } ?>
            <tfoot>
