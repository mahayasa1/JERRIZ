...
<br>
  ...
  <br>
    <h3 class="text-center">Formulir Upload Dokumen</h3>
    <br>
    <form id="uploadForm" action="tambah_pesan_proses.php" method="post" enctype="multipart/form-data">
        <div class="mb-3 row">
        ...
        <div class="mb-3 row">
            ...
            <div class="col-sm-10">
                <input type="file" name="file" id="file" class="form-control" accept=".docx, .pdf" required>
            </div>
        </div>
        <div class="col-sm-10">
