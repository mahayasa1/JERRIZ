...
<div class="card position-absolute top-50 start-50 translate-middle" style="width: 18rem;">
    ...
    <form action="login.php" method="POST" enctype="multipart/form-data" onsubmit="return validasi()">
